  ...
  return (
    <div className="App">
      <Container fluid>
        ...
        <p className="lead">
          My Name is Ishaan Chawla and I am a student at wynisco.{" "}
        </p>
        <p className="lead">
          <a href="https://github.com/IshaanChawla0001">Here</a> is my Github
          Link{" "}
        </p>
        <p className="lead">
          <a href="http://webdevnotes.wynisco.com">Here</a> Here is Class Notes
          Link{" "}
        </p>
        <p className="lead">
